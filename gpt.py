...
openai.api_key = "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"
...
def gen_images(prompts, quality, image_style):
  if quality == "low":
    ...
    engine_type = "stable-diffusion-xl-beta-v2-2-2"
    n_steps = 30
...
def gen_html(gpt_model, topic, sentences, slogan, images, background):
...
def gen_website(gpt_model, topic, tasks, tasks_remark, number, quality, image_style):
  ...
  print("generating html...")
	html_file = gen_html(gpt_model, topic, sentences, slogan, images, background)
...
if __name__ == '__main__':
	...
	topic = "Macbook Pro"
	tasks = "Introduce the Macbook Pro product's features."
	tasks_remark = "Introduce 3 different features. Must include the Retina display technology."
	number = 3
	quality = "high"
	image_style = "3d-model"

	gen_website(gpt_model, topic, tasks, tasks_remark, number, quality, image_style)
